...
::: {.center}
![URLs del Proyecto en Django](/images/urls_django.png){.center}
:::
...
## 11. Aplicar una migración

::: {.center}
![Aplicación de las Migraciones en Django](/images/aplicacion_migraciones_django){.center}
:::
