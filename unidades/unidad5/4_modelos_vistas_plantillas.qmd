...
::: {.callout-tip}
**Tip:** Para crear un proyecto de Django, utilizamos el comando **django-admin startproject**. En este caso utilizamos la versión LTS, recuerda que puedes consultar la versión más reciente en la [página oficial de Django](https://www.djangoproject.com/download/). Sin embargo en este caso utilizaremos la versión 4.2.0.
:::
...
1. Agregamos la ruta de la carpeta **templates** al directorio de plantillas.
